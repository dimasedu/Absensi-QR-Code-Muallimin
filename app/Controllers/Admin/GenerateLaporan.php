...
class GenerateLaporan extends BaseController
{
   ...
   public function index()
   {
      ...
      foreach ($kelas as $value) {
         array_push($siswaPerKelas, $this->siswaModel->getSiswaByKelas($value['id_kelas'],$thajar));
      }
      ...
      foreach ($period as $value) {
         ...
         if (!($value->format('D') == 'Sun')) {
            ...
            $absenByTanggal = $this->presensiSiswaModel
               ->getPresensiByKelasTanggal2($idKelas, $value->format('Y-m-d'),$thajar);
   ...
   public function generateLaporanGuru()
   {
      ...
      $data = [
         ...
         'grup' => 'guru',
         'namaSekolah' => $this->namaSekolah,
         'tahunAjaran' => $this->session->get('thajar')
      ];
