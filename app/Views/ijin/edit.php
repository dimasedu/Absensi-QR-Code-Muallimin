      ...
      <div class="col-lg-12 col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title"><b>Ubah Data Izin / Sakit</b></h4>
          </div>
          <div class="card-body mx-5 my-3">
            ...
            <form action="<?= site_url('admin/absensi-ijin/update'); ?>" method="post" enctype="multipart/form-data" class="form-default">
              ...
              <div class="form-group mt-4">
                ...
                <input type="date" name="tanggal" class="form-control" required id="tanggal" value="<?=$query->tanggal?>">
              ...
              <div class="form-group mt-4">
                ...
                <select name="siswa" id="siswa" class="form-control select2" required placeholder="Masukkan NISN/Nama Siswa">
                    ...
                    foreach($siswa as $row){
                        ?>
                        <option 
                        value="<?=$row->id_siswa?>|<?=$row->no_hp;?>|<?=$siswalib->get_kelas_id($row->id_siswa);?>" 
                        <?=$query->id_siswa == $row->id_siswa ? 'selected="selected"' : '';?>>
                            <?=$row->nama_siswa;?> (<?=$row->nis;?>) - <?=$siswalib->get_kelas($row->id_siswa);?>
                        </option>
                        <?php
                    }
                    ?>
              ...
              <div class="form-group mt-4">
                ...
                <input 
                    ...
                    id="ijin" 
                    required 
                    value="I" <?=$query->tipe == "I" ? 'checked="checked"' : '';?>
                /> 
                <span class="badge bg-success text-white">IZIN</span> &nbsp;
