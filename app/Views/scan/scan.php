 ...
 <div class="main-panel">
    <div class="content">
       ...
       <!--<div class="alert alert-danger"><marquee direction="left" scrollamount="2" scrolldelay="30">>>>>>>>>>>>>>>>>>>>> <b>UNDER MAINTENANCE / MASIH DALAM TAHAN PERBAIKAN.</b> <<<<<<<<<<<<<<<<<<<<<<<</marquee></div>-->
          <div class="row mx-auto">
           
             <div class="col-lg-3 col-xl-4">
                <div class="card">
                   <div class="card-header">
                     <h4 class="card-title"><b>Tips</b></h4>
                   </div>
                   <div class="card-body">
                      <ul class="pl-3">
             ...
             <div class="col-lg-6 col-xl-4">
                <div class="card">
                   <div class="col-12 mx-auto card-header card-header-primary">
                      <div class="row">
                         <div class="col">
                   ...
                   <div class="card-body">
                      <label class="d-inline">Pilih kamera</label>
                      ...
                      <div class="row">
                        <div class="col-sm-12 mt-3">
                           <input type="text" class="form-control" id="kode" name="kode" placeholder="Ketik NISN/NIP atau Scan dengan alat" autofocus="autofocus">
                         </div>
             ...
             <div class="col-lg-3 col-xl-4">
                <div class="card">
                   <div class="card-header">
                     <h4 class="card-title"><b>Penggunaan</b></h4>
                   </div>
                   <div class="card-body">
                      <ul class="pl-3">
