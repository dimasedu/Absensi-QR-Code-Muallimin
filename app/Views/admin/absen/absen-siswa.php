                        ...
                        <div class="pt-3 pl-3">
                           ...
                           <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                 ...
                                 <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Notifikasi Laporan Izin/Sakit</h5>
                                 <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                 </button>
                                 </div>
                                 <div class="modal-body">
                                    <form action="<?=site_url('admin/absensi-ijin/notif')?>" method="post">
                                 ...
                                 <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn bg-info">Kirim</button>
                                    </form>
                                 </div>
                              </div>
                           </div>
